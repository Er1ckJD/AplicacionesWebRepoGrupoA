import { hasClass } from 'uikit/src/js/util/class';
import { dimensions, offset, offsetPosition } from 'uikit/src/js/util/dimensions';
import { isVisible, parent, parents } from 'uikit/src/js/util/filter';
import {
    clamp,
    findIndex,
    includes,
