import { attr } from 'uikit/src/js/util/attr';
import { index, matches } from 'uikit/src/js/util/filter';
import { isDocument, isString, memoize, toNode, toNodes } from 'uikit/src/js/util/lang';
