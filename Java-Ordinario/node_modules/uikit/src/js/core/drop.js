...
import Container from 'uikit/src/js/mixin/container';
import { maybeDefautPreventClick } from 'uikit/src/js/mixin/event';
import Position, { storeScrollPosition } from 'uikit/src/js/mixin/position';
import Togglable from 'uikit/src/js/mixin/togglable';
import { keyMap } from 'uikit/src/js/util/keys';
import { preventBackgroundScroll } from 'uikit/src/js/util/scroll';
