...
import { component, getComponent, getComponents } from 'uikit/src/js/api/component';
import { mergeOptions } from 'uikit/src/js/api/options';
import { init } from 'uikit/src/js/api/state';
